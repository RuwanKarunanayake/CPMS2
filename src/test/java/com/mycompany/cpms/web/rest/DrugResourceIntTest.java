...
import com.mycompany.cpms.domain.enumeration.Status;
/**
...
public class DrugResourceIntTest {
    ...
    private static final Status DEFAULT_AMOUNT_STATUS = Status.HIGH;
    private static final Status UPDATED_AMOUNT_STATUS = Status.MEDIUM;
    ...
    public static Drug createEntity(EntityManager em) {
        Drug drug = new Drug()
            ...
            .amountStatus(DEFAULT_AMOUNT_STATUS);
        return drug;
    }
    ...
    public void createDrug() throws Exception {
        ...
        assertThat(testDrug.getAmountStatus()).isEqualTo(DEFAULT_AMOUNT_STATUS);
    }
    ...
    @Test
    @Transactional
    public void checkAmountStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = drugRepository.findAll().size();
        // set the field null
        drug.setAmountStatus(null);
    ...
    public void getAllDrugs() throws Exception {
        ...
        restDrugMockMvc.perform(get("/api/drugs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].amountStatus").value(hasItem(DEFAULT_AMOUNT_STATUS.toString())));
    }
    ...
    public void getDrug() throws Exception {
        ...
        restDrugMockMvc.perform(get("/api/drugs/{id}", drug.getId()))
            ...
            .andExpect(jsonPath("$.amountStatus").value(DEFAULT_AMOUNT_STATUS.toString()));
    }
    ...
    public void updateDrug() throws Exception {
        ...
        updatedDrug
            ...
            .amountStatus(UPDATED_AMOUNT_STATUS);
        ...
        assertThat(testDrug.getAmountStatus()).isEqualTo(UPDATED_AMOUNT_STATUS);
    }
