...
public class RecordingResourceIntTest {
    ...
    private static final Boolean DEFAULT_NONETENDER = false;
    private static final Boolean UPDATED_NONETENDER = true;
    ...
    public void createRecording() throws Exception {
        ...
        assertThat(testRecording.getComplain()).isEqualTo(DEFAULT_COMPLAIN);
        ...
        assertThat(testRecording.isNonetender()).isEqualTo(DEFAULT_NONETENDER);
        ...
        assertThat(testRecording.getPrescription()).isEqualTo(DEFAULT_PRESCRIPTION);
    }
    ...
    @Test
    @Transactional
    public void checkComplainIsRequired() throws Exception {
        int databaseSizeBeforeTest = recordingRepository.findAll().size();
        // set the field null
        recording.setComplain(null);
    ...
    public void getAllRecordings() throws Exception {
        ...
        restRecordingMockMvc.perform(get("/api/recordings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nonetender").value(hasItem(DEFAULT_NONETENDER.booleanValue())))
    ...
    public void getRecording() throws Exception {
        ...
        restRecordingMockMvc.perform(get("/api/recordings/{id}", recording.getId()))
            ...
            .andExpect(jsonPath("$.nonetender").value(DEFAULT_NONETENDER.booleanValue()))
    ...
    public void updateRecording() throws Exception {
        ...
        Recording testRecording = recordingList.get(recordingList.size() - 1);
        assertThat(testRecording.getComplain()).isEqualTo(UPDATED_COMPLAIN);
        ...
        assertThat(testRecording.isNonetender()).isEqualTo(UPDATED_NONETENDER);
        ...
        assertThat(testRecording.getPrescription()).isEqualTo(UPDATED_PRESCRIPTION);
    }
