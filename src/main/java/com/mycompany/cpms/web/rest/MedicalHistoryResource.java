...
public class MedicalHistoryResource {
    ...
    @Timed
    public ResponseEntity<List<MedicalHistory>> getAllMedicalHistories(@ApiParam Pageable pageable) {
        log.debug("REST request to get a page of MedicalHistories");
        Page<MedicalHistory> page;
        if(SecurityUtils.isCurrentUserInRole("ROLE_ADMIN")) {
            page = medicalHistoryRepository.findAll(pageable);
        }else{
            page = medicalHistoryRepository.findByMedicalHistoryUserLogin(pageable);
