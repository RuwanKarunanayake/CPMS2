...
public class Userinfo implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "userinfo_clinic",
               joinColumns = @JoinColumn(name="userinfos_id", referencedColumnName="id"),
    ...
    public Userinfo clinics(Set<Clinic> clinics) {
        this.clinics = clinics;
        return this;
    }

    public Userinfo addClinic(Clinic clinic) {
        this.clinics.add(clinic);
        clinic.getUserinfos().add(this);
        return this;
    }

    public Userinfo removeClinic(Clinic clinic) {
        this.clinics.remove(clinic);
        clinic.getUserinfos().remove(this);
        return this;
    }
